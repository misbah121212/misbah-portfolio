  ...
  return (
    <section id="about" className="relative w-full overflow-hidden">
      ...
      <div ref={containerRef} className="relative z-10 w-full max-w-6xl mx-auto flex flex-col gap-16">
        ...
        <motion.div 
          style={{ scale }}
          className="w-full bg-white/5 backdrop-blur-2xl rounded-[3rem] p-12 md:p-20 relative overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.05)] border border-white/20 group"
        >
          {/* Glass reflections */}
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-tr from-white/5 to-white/10 pointer-events-none" />
