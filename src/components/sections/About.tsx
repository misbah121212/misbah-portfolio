  ...
  return (
    <section id="about" className="relative w-full overflow-hidden">
      ...
      <motion.img 
        ...
        className="absolute top-[2%] -left-2 md:-left-4 w-32 h-32 md:w-56 md:h-56 z-30 drop-shadow-2xl object-contain pointer-events-none" 
      />
      <motion.img 
        src="/3d-flower.png" 
        alt="3D Flower" 
        ...
        className="absolute top-[35%] -right-2 md:-right-4 w-28 h-28 md:w-48 md:h-48 z-30 drop-shadow-2xl object-contain pointer-events-none" 
      />
      <motion.img 
        src="/3d-heart.png" 
        alt="3D Heart" 
      ...
      <div ref={containerRef} className="relative z-10 w-full max-w-6xl mx-auto flex flex-col gap-16">
        ...
        <motion.div 
          style={{ scale }}
          className="w-full bg-white/10 backdrop-blur-3xl rounded-[3rem] p-12 md:p-20 relative overflow-hidden shadow-[0_8px_32px_rgba(165,152,243,0.15)] border border-white/50 group hover:-translate-y-2 hover:scale-[1.01] hover:shadow-[0_15px_40px_rgba(165,152,243,0.25)] transition-all duration-500"
        >
          ...
          <div className="absolute inset-0 rounded-[3rem] shadow-[inset_0_0_30px_rgba(255,255,255,0.7)] pointer-events-none" />
