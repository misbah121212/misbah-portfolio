  ...
  return (
    <SectionWrapper id="about" className="pt-2 pb-8 md:pt-4 md:pb-24 relative overflow-hidden">
      ...
      <motion.img 
        ...
        className="absolute top-[10%] -left-10 md:-left-16 w-32 h-32 md:w-56 md:h-56 z-20 drop-shadow-2xl object-contain pointer-events-none" 
      />
      <motion.img 
        src="/3d-flower.png" 
        alt="3D Flower" 
        ...
        className="absolute top-[25%] -right-6 md:-right-12 w-28 h-28 md:w-48 md:h-48 z-20 drop-shadow-2xl object-contain pointer-events-none" 
      />
      <motion.img 
        src="/3d-heart.png" 
        alt="3D Heart" 
        ...
        className="absolute bottom-[30%] -left-8 md:-left-16 w-36 h-36 md:w-60 md:h-60 z-20 drop-shadow-2xl object-contain pointer-events-none" 
      />
      <motion.img 
        src="/3d-ribbon.png" 
        alt="3D Ribbon" 
        ...
        className="absolute bottom-[10%] -right-10 md:-right-20 w-32 h-32 md:w-56 md:h-56 z-20 drop-shadow-2xl object-contain pointer-events-none" 
      />
