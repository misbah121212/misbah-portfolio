...
export const RightSkillsPanel = () => {
  return (
    <TiltCard className="w-[300px] h-full flex-shrink-0">
      <div className="w-full h-full flex flex-col bg-navy/35 backdrop-blur-3xl border border-white/15 rounded-[2.5rem] p-6 shadow-[0_12px_40px_rgba(0,0,0,0.25)] relative overflow-hidden">
